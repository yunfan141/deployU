...
let DomainService = class DomainService {
    ...
    getDomainById(domainId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.domainRepository.findOne({ where: { id: domainId } });
        });
    }
    addDomain(domain) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    updateDomain(domainId, newDomain) {
        return __awaiter(this, void 0, void 0, function* () {
            const selectedDomain = yield this.domainRepository.findOne({ where: { id: domainId } });
            if (selectedDomain) {
                yield this.domainRepository.update(domainId, newDomain);
                return yield this.domainRepository.findOne({ where: { id: domainId } });
            }
            else {
                return null;
    ...
    deleteDomain(domainId) {
        return __awaiter(this, void 0, void 0, function* () {
            const selectedDomain = yield this.domainRepository.findOne({ where: { id: domainId } });
            if (selectedDomain) {
                yield this.domainRepository.delete(domainId);
