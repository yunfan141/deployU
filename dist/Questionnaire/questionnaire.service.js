...
let QuestionnaireService = class QuestionnaireService {
    ...
    getQuestionnaireById(questionnaireId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.questionnaireRepository.findOne({ where: { id: questionnaireId } });
        });
    }
    addQuestionnaire(questionnaire) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.questionnaireRepository.save(questionnaire);
        });
    }
    updateQuestionnaire(questionnaireId, newQuestionnaire) {
        return __awaiter(this, void 0, void 0, function* () {
            const selectedQuestionnaire = yield this.questionnaireRepository.findOne({ where: { id: questionnaireId } });
            if (selectedQuestionnaire) {
                yield this.questionnaireRepository.update(questionnaireId, newQuestionnaire);
                return yield this.questionnaireRepository.findOne({ where: { id: questionnaireId } });
            }
            else {
                return null;
    ...
    deleteQuestionnaire(questionnaireId) {
        return __awaiter(this, void 0, void 0, function* () {
            const selectedQuestionnaire = yield this.questionnaireRepository.findOne({ where: { id: questionnaireId } });
            if (selectedQuestionnaire) {
                yield this.questionnaireRepository.delete(questionnaireId);
