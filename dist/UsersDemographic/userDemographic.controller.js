...
let UserDemographicController = class UserDemographicController {
    ...
    getAllUserDemographic() {
        return __awaiter(this, void 0, void 0, function* () {
            const msg = yield this.userDemographicService.getAllUserDemographics();
            return msg;
        });
    }
    getUserDemographicById(params) {
        return __awaiter(this, void 0, void 0, function* () {
            const msg = yield this.userDemographicService.getUserDemographicById(params.id);
            return msg;
        });
    }
    addUserDemographic(userDemographic) {
        return __awaiter(this, void 0, void 0, function* () {
            const msg = yield this.userDemographicService.addUserDemographic(userDemographic);
            return msg;
        });
    }
    updateUserDemographic(params, newUserDemographic) {
        return __awaiter(this, void 0, void 0, function* () {
            const msg = yield this.userDemographicService.updateUserDemographic(params.id, newUserDemographic);
            return msg;
        });
    }
};
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], UserDemographicController.prototype, "getUserDemographicById", null);
__decorate([
    common_1.Post(),
